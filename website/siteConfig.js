...
const siteConfig = {
  ...
  projectName: 'chatbot-hr-book',
  organizationName: 'FREDUNIVERSE',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Freddy Munandar`,
  ...
  repoUrl: 'https://github.com/freddymu/chatbot-hr-book',
  docsUrl: '',
  scrollToTop: true,
